...
int main(int argc, char* argv[]){
    ...
    for (uint32_t iterator = 0; iterator < masterList.size(); iterator++) {
        categoryToID[masterList[iterator].sortCategory].push_back(iterator);

        set<string> insertWordsIntoKeyWordMap;
        string messageToBeSplit = masterList[iterator].message;

        transform(messageToBeSplit.begin(), messageToBeSplit.end(), 
        messageToBeSplit.begin(), ::tolower);
        splitStrings(messageToBeSplit, insertWordsIntoKeyWordMap);

        messageToBeSplit = masterList[iterator].sortCategory; 
        splitStrings(messageToBeSplit, insertWordsIntoKeyWordMap);
    ...
    do {
        ...
        if (command == '#') {
            ...
            for(uint32_t i : searchedEntries){
                cout << masterList[i].entryID << "|" 
                << masterList[i].stringTimeStamp
                << "|" << masterList[i].category << "|" 
                << masterList[i].message << '\n';
            }
        }
        else if (command == 'a') {
            ...
            for (uint32_t ID : excerpt) {
                cout << counter << "|" << masterList[ID].entryID 
                << "|" << masterList[ID].stringTimeStamp 
                << "|" << masterList[ID].category << "|" 
                << masterList[ID].message << "\n";
                counter++;
            }
        }
        else if (command == 't') {
            ...
            auto lowerBound = lower_bound(masterList.begin(), masterList.end(),
                timeStamp1, LogEntry());
            ...
            auto upperBound = upper_bound(lowerBound, masterList.end(),
                timeStamp2, LogEntry());
            ...
            if (excerpt.empty()) {
                ...
                cout << "0|" << masterList[excerpt[0]].entryID << "|" 
                << masterList[excerpt[0]].stringTimeStamp 
                << "|" << masterList[excerpt[0]].category << "|" 
                << masterList[excerpt[0]].message << "\n";
                cout << "..." << '\n'; 
                unsigned long int excerptSizeL = excerpt.size() - 1; 
                cout << excerptSizeL << "|" 
                << masterList[excerpt[excerptSizeL]].entryID << "|" 
                << masterList[excerpt[excerptSizeL]].stringTimeStamp 
                << "|" << masterList[excerpt[excerptSizeL]].category 
                << "|" << masterList[excerpt[excerptSizeL]].message << "\n";
                excerpt.clear();
            }
        }
        else if (command == 'b') {
            ...
            auto lowerBound = lower_bound(masterList.begin(), masterList.end(),
                searchedEntry, LogEntry());
            if (lowerBound == masterList.end()) {
                cout << "Timestamp search: 0 entries found" << '\n';
                continue;
            }
            auto upperBound = upper_bound(masterList.begin(), masterList.end(),
                searchedEntry, LogEntry());
            searchedEntries.clear();
            ...
            if (excerpt.empty()) {
                ...
                cout << excerptSizeS << "|" 
                << masterList[excerpt[excerptSizeS]].entryID << "|" 
                << masterList[excerpt[excerptSizeS]].stringTimeStamp 
                << "|" << masterList[excerpt[excerptSizeS]].category 
                << "|" << masterList[excerpt[excerptSizeS]].message << '\n';
                ...
                cout << excerptSizeS <<"|" 
                << masterList[excerpt[excerptSizeS2]].entryID << "|" 
                << masterList[excerpt[excerptSizeS2]].stringTimeStamp 
                << "|" << masterList[excerpt[excerptSizeS2]].category 
                << "|" << masterList[excerpt[excerptSizeS2]].message << '\n';
            }
        }
    } while (command != 'q');
}